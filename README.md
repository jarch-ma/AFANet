...
Download pre-trained weights (Backbone): ResNet50, VGG16 and ViT (CLIP) from Google Drive: [[Hugging Face]([https://drive.google.com/file/d/1HKOGnvijW_KGTja_AdyHisRMXztoT10J](https://huggingface.co/datasets/Jarch-ma/AFANet/tree/main))].
