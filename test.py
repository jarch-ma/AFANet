...
if __name__ == '__main__':  
    ...
    parser.add_argument('--load', type=str, default='/opt/data/private/Code/AFANet/Pretrain/vis/voc_fold_0.pt')
    parser.add_argument('--fold', type=int, default=0, choices=[0, 1, 2, 3])
    parser.add_argument('--nshot', type=int, default=1)
    parser.add_argument('--backbone', type=str, default='resnet50', choices=['vgg16', 'resnet50', 'resnet101'])
    parser.add_argument('--visualize', action='store_true') # or just: default='visualize'
    ...
    parser.add_argument('--vispath', type=str, default='/opt/data/private/Code/AFANet/vis/voc/fold0/')
