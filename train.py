...
if __name__ == '__main__':
    ...
    parser.add_argument('--niter', type=int, default=50)  # # epoch
    ...
    parser.add_argument('--traincampath', type=str, default='.../afanet_data/Out/voc_cam/CAM_VOC_Train/')
    parser.add_argument('--valcampath', type=str, default='.../afanet_data/Out/voc_cam/CAM_VOC_Val/')

    # parser.add_argument('--traincampath', type=str, default='.../afanet_data/Out/coco_cam/')
    # parser.add_argument('--valcampath', type=str, default='.../afanet_data/Out/coco_cam/')
